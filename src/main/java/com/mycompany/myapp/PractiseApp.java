...
public class PractiseApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(PractiseApp.class);

    private final Environment env;

    public PractiseApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes practise.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(PractiseApp.class);
